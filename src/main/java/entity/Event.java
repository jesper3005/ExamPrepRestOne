...
@NamedQueries({
    ...
    , @NamedQuery(name = "EventDTO.findByPetsByDate", query = "SELECT NEW DTO.PetDTO(e.pet.id, e.pet.name, e.pet.birth, e.pet.species, e.pet.death, e.pet.owner.firstName) FROM Event e WHERE e.date = :date")})
